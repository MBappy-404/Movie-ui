...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      document.documentElement.style.setProperty('--scroll-opacity', Math.min(scroll / 80, 1).toString());
    };
                  ...
                  {dropdownOpen && (
                    ...
                    >
                      <div className="px-4 py-2 border-b border-gray-700">
                        <p className="text-sm font-medium text-gray-200">john@example.com</p>
                      </div>
                      <a href="/profile" className="flex items-center gap-2 px-4 py-2 text-gray-300 hover:bg-gray-700">
